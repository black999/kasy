...
urlpatterns = [
    ...
    path('odczyt/<int:pk>/zatwierdz',
         views.odczyt_zatwierdz, name='odczyt_zatwierdz'),
    path('odczyt/<int:pk>/usun',
         views.odczyt_usun, name='odczyt_usun'),
    path('odczyt/<int:pk>/raportUS',
         views.odczyt_raportUS, name='odczyt_raportUS'),
