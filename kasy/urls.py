...
urlpatterns = [
    ...
    path('kasa/<int:pk>/zgloszenieUS_podatnik', views.zgloszenieUS_podatnik,
         name='zgloszenieUS_podatnik'),
    path('kasa/<int:pk>/zgloszenieUS_serwis', views.zgloszenieUS_serwis,
         name='zgloszenieUS_serwis'),
    ...
    path('kasa/do_wymiany', views.kasa_do_wymiany, name='kasa_do_wymiany'),
